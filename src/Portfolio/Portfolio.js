...
const Portfolio = () => {
  return (
    <div>
      <div className=" contactHeader text-5xl w-full grid place-items-center font-bold text-gray-600 font-sans my-2">
        <h1>Projects</h1>
      </div>
      <div className="w-full mt-10 portfolio h-auto flex justify-evenly gap-6 pt-4 pb-4">
